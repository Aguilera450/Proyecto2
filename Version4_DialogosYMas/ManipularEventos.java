...
public class ManipularEventos {
    ...
    public void checarEvento(){
        if(colision(39, 26, "cualquiera") == true){
            gP.estadoActual = gP.estadoPelea;
        }

        if(colision(38, 25, "cualquiera") == true){
            gP.jugador.mundoX = gP.tileSize*2;
            gP.jugador.mundoY = gP.tileSize*2;
            gP.tileM.cargarMapa("Mapa2.txt");
        }
    }
